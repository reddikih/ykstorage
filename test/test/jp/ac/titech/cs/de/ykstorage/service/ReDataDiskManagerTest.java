...
public class ReDataDiskManagerTest {
	...
	private ReDataDiskManager dm;
	private ReDataDiskStateManager ddsm;
//	private String devicePaths[];

	@Before
	public void setUpClass() {
		this.ddsm = new ReDataDiskStateManager(Parameter.MOUNT_POINT_PATHS, Parameter.DATA_DISK_PATHS,
	...
	public void loadAndSaveTest() {
		...
		ReDataDiskManager dm2 = new ReDataDiskManager(
								Parameter.DATA_DISK_PATHS,
								Parameter.DATA_DISK_SAVE_FILE_PATH,
								Parameter.MOUNT_POINT_PATHS,
								Parameter.SPIN_DOWN_THRESHOLD,
